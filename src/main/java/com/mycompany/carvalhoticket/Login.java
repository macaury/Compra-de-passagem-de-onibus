...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBackground(new java.awt.Color(20, 50, 55));
        jLabel1.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Usuario");

        jLabel2.setBackground(new java.awt.Color(20, 50, 55));
        ...
        jButtonEntrar.setFont(new java.awt.Font("Dialog", 0, 12)); // NOI18N
        ...
        jLabel4.setForeground(new java.awt.Color(222, 102, 222));
        jLabel4.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel4.setText("Painel de entrada");
    ...
    private void jButtonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEntrarActionPerformed
        ...
        us = this.usuario.getText(); // usuario 
        pa = this.Senha.getText(); //  senha
        
       if ((usuario.getText().isEmpty()) || (Senha.getText().isEmpty())) {
   JOptionPane.showMessageDialog(null, "Os campos não podem retornar vazios");
}else {
       Boolean Enviar = V.Verify(us,pa);
        if(Enviar == true ){
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
         Cadastro tela_cad = new Cadastro();
